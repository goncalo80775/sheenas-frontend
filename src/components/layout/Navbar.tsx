const Navbar = () => {
  return (
    <nav className="fixed top-0 w-full z-50 bg-[#FDF0D5]/90 backdrop-blur-sm border-b border-[#003049]/10 shadow-sm">
      <div className="max-w-6xl mx-auto flex justify-between items-center p-4">
        <div className="text-[#003049] font-bold text-xl">GM</div>
        <div className="hidden md:flex gap-8">
          <a href="#home" className="text-[#003049] font-medium relative group">
            Home
        ...
        <div className="flex gap-4">
          <a
            ...
            aria-label="GitHub"
            className="text-[#003049] hover:text-[#C1121F] transition-all duration-300 hover:scale-110"
          >
            <svg
